...
from homeassistant.components.elkm1.config_flow import CannotConnect, InvalidAuth
...
async def test_form(hass):
    ...
    with patch(
        "homeassistant.components.elkm1.config_flow.PlaceholderHub.authenticate",
        return_value=True,
    ), patch(
