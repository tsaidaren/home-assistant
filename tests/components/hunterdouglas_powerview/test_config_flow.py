...
from homeassistant.components.hunterdouglas_powerview.config_flow import (
    CannotConnect,
    InvalidAuth,
)
...
async def test_form(hass):
    ...
    with patch(
        "homeassistant.components.hunterdouglas_powerview.config_flow.PlaceholderHub.authenticate",
        return_value=True,
    ), patch(
