...
class TestComponentLogbook(unittest.TestCase):
    ...
    def test_exclude_events_entity(self):
        ...
        self.assert_entry(entries[1], pointB, "blu", entity_id=entity_id2)
    ...
    def test_include_events_domain(self):
        ...
        self.assert_entry(entries[2], pointB, "blu", entity_id=entity_id2)
    ...
    def test_include_events_domain_glob(self):
        ...
        self.assert_entry(entries[1], name="Amazon Alexa", domain="alexa")
        self.assert_entry(entries[2], pointB, "blu", entity_id=entity_id2)
        self.assert_entry(entries[3], pointC, "included", entity_id=entity_id3)
    ...
    def test_include_exclude_events(self):
        ...
        self.assert_entry(entries[2], pointA, "blu", entity_id=entity_id2)
        self.assert_entry(entries[3], pointB, "bla", entity_id=entity_id)
        self.assert_entry(entries[4], pointB, "blu", entity_id=entity_id2)
    ...
    def test_include_exclude_events_with_glob_filters(self):
        ...
        self.assert_entry(entries[3], pointB, "bla", entity_id=entity_id)
        self.assert_entry(entries[4], pointB, "blu", entity_id=entity_id2)
        self.assert_entry(entries[5], pointC, "included", entity_id=entity_id4)
