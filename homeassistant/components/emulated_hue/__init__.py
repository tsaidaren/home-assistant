...
class Config:
    ...
    def is_entity_exposed(self, entity):
        ...
        explict_hidden_bool_in_config = self._entities_with_hidden_attr_in_config.get(
            entity.entity_id, None
        )
        if explict_hidden_bool_in_config is not None:
            return not explict_hidden_bool_in_config
        ...
        if entity.domain.lower() in self.exposed_domains:
            return True
